                    ...
                    <div style={{ marginTop: 24 }}>
                        ...
                        <div className="card responsiveColumn" style={{ justifyContent: "space-between"}}>
                            <div style={{ width: '100%' }}>
                                ...
                                <p style={{ fontWeight: 'bold', fontSize: 98, color: '#AAFFA9' }}>R$ {props.dataSearch.result.toFixed(2).replace('.', ',')}</p>
                            </div>
                            <div style={{ width: '100%' }}>
                                <p style={{ fontSize: 24, margin: '16px 0' }}>Porcentagem de assertividade(PA):</p>
                                <p style={{ fontWeight: 'bold', fontSize: 98, color: '#AAFFA9' }}>PA: 99,85 %</p>
                            </div>
                        </div>
                    </div>
